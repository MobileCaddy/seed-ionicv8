 ...
 */
  ...
  function importScripts() {
    return new Promise((resolve, _reject) => {
      ...
      imported2.src = window.ASSET_ROOT + 'assets/js/mockVFRemote.js';
      document.head.appendChild(imported2);
  
      let imported3 = document.createElement('script');
      imported3.src = window.ASSET_ROOT + 'assets/js/force.js';
  ...
  function setScrub() {
    ...
    switch (qScrub) {
      ...
      default:
        ...
        let myUri = window.ASSET_ROOT + 'assets/mc-params.json';
